...
class VenueForm(FlaskForm):
    ...
    image_link = StringField(
        'image_link', validators=[URL(message="image url error"),Optional()]
    )
    ...
    facebook_link = StringField(
        'facebook_link', validators=[URL(message="facebook_link url error"),Optional()]
    )

    website = StringField(
        'website', validators=[URL(message="website url errors"),Optional()]
    )
